      ...
      <div className="flex items-center gap-3">
        ...
        <div>
          <h1 className="text-2xl font-bold tracking-tight inline-flex items-center gap-2">
            <Trash2 className="w-5 h-5 text-[var(--color-fg-muted)]" />
            Trash
          </h1>
            ...
            >
              ...
              <div className="flex items-center gap-1 shrink-0">
                ...
                <button
                  ...
                  className="p-1.5 rounded text-[var(--color-fg-muted)] hover:text-[var(--color-danger)] hover:bg-[var(--color-danger-subtle)]"
                >
